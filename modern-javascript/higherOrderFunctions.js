...
// Test Data 
let numberArray = [29.45, 40.24, 13.72, 75.01, 68.84, 14.33, 39.87]
...
fruits.forEach(fruit => console.log(`I ate a ${fruit.color} ${fruit.name} that was about ${fruit.diameter}" in diameter.`));
