...
// OR can be used when the value is truthy/falsy to say if it
...
avengers.forEach(avenger => {
	let availableText = avenger.available ? 'available' : 'unavailable';
	console.log(`${avenger.aka || avenger.name} is ${availableText}`);
});

// TODO: For the importExport exercise, put your export statement here:
