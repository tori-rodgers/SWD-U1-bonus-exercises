...
describe('The isAlphaOnly function', () => {
    ...
    test('should return true if the string has spaces', () => {
    ...
    test('should return false if the string has punctuation', () => {
    ...
    test('should return false if value is not a string type', () => {
        expect(examples.isAlphaOnly(cap.calculateAge())).toBe(false); // number
        expect(examples.isAlphaOnly(cap.catchphrases)).toBe(false); // array
        expect(examples.isAlphaOnly(cap)).toBe(false); // object
        expect(examples.isAlphaOnly(cap.calculateAge)).toBe(false); // function
        expect(examples.isAlphaOnly(null)).toBe(false); // null
    });
});
